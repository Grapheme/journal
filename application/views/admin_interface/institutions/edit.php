		...
		<div class="row">
			...
			<div class="span9">
				<ul class="breadcrumb">
					...
					<li><a href="<?=site_url(ADMIN_START_PAGE.'/institutions');?>">Учреждения</a> <span class="divider">/</span></li>
					<li class="active">Редактирование учреждения</li>
				</ul>
				<div class="clear"></div>
				<?php $this->load->view('admin_interface/forms/manage-institutions/edit');?>
			</div>
		</div>
	</div>
