	...
	<div class="container">
		<div class="row">
			...
			<div class="span9">
				...
				<div class="clear"></div>
				<blockquote>
					<a href="<?=site_url(ADMIN_START_PAGE.'/pages/mode');?>" class="btn btn-small btn-warning" type="button">Отменить добавление</a>
				</blockquote>
				<div class="clear"></div>
				<?php $this->load->view('admin_interface/forms/manage-page/add')?>
			</div>
		</div>
	</div>
