...
<nav>
	<ul class="nav-list">
		<li class="nav-item"><a <?=($posNav == 0)?'class="active"':''?> href="<?=site_url('issues');?>"><?=lang('menu_issues');?></a></li>
		<li class="nav-item"><a <?=($posNav == 1)?'class="active"':''?> href="<?=site_url('authors');?>"><?=lang('menu_authors');?></a></li>
		<li class="nav-item"><a <?=($posNav == 2)?'class="active"':''?> href="<?=site_url('for-authors');?>"><?=lang('menu_for_authors');?></a></li>
